...
export function ParadasTable() {
  ...
  const handleEdit = (parada: Parada) => {
    toast.info(`Editar parada ${parada.id_parada}`);
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      await paradasService.delete(id);
      setParadas(paradas.filter((p) => p.id_parada !== id));
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {/* Botón Crear */}
        <Button onClick={() => toast.info("Modal de crear próximamente")}>
                  ...
                  <TableCell>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          onClick={() => handleDelete(parada.id_parada)}
